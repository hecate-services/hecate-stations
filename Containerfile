...
LABEL org.opencontainers.image.source="https://github.com/hecate-services/hecate-stations"
...
WORKDIR /app
COPY --from=builder /build/_build/prod/rel/hecate_stations ./

ENV HOME=/app
ENV RELX_REPLACE_OS_VARS=true

ENV HECATE_NODE_NAME=hecate_stations
ENV HECATE_NODE_HOST=127.0.0.1
ENV HECATE_COOKIE=hecate_stations
ENV HECATE_HEALTH_PORT=8495
...
CMD ["/app/bin/hecate_stations", "foreground"]
